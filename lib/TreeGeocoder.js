...
class TreeGeocoder {
    constructor() {
        ...
        this._prefixSource = 'http://n076-12.wall1.ilabt.iminds.be/geonames-prefix-tree/node0.jsonld#Collection';
        this._suffixSource = 'http://n076-12.wall1.ilabt.iminds.be/geonames-suffix-tree/node0.jsonld#Collection';
    }
    ...
    extractSuffixResults(res, query) {
        let entities = new Map();
        let ids = [];
        let results = [];
